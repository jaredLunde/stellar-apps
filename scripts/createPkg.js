    ...
    (resolve, reject) => cmd.get(
      ...
      (err, data, stderr) => {
        ...
        if (!err) {
          ...
          pkgJson.set(
            'repository',
            `https://github.com/jaredLunde/stellar-apps/tree/master/packages/${pkgName}`
          )
          pkgJson.set('name', `@stellar-apps/${pkgName}`)
          ...
          cmd.get(
            `
              ...
              yarn add --cwd ${pathName} @babel/runtime-corejs3 @babel/runtime
